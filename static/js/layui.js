...
;!function (d) {
    ...
    var t, h = d.document, m = {modules: {}, status: {}, timeout: 10, event: {}}, n = function () {
        ...
        return this
    }, n.prototype.sort = function (t, o, e, r) {
        r = r ? t || [] : JSON.parse(JSON.stringify(t || []));
...
!function (p) {
    ...
    var m, c, e, n = p.layui && layui.define, f = {
        ...
        i = (d.anim = {
            ...
            var s, e,
                l = (t = m("." + d[0]).find("#" + a).closest("." + d[0]))[0] ? (a = t.attr("times"), t) : m("#" + d[0] + a),
                r = l.attr("type"), t = l.data() || {}, i = {
                ...
                input: function (e) {
                    ...
                    e.each(function (e, t) {
                        var i = b(this), a = i.attr("lay-skin") || "primary",
                            n = b.trim(t.title || (t.title = i.attr("lay-text") || "")), l = this.disabled,
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function (e) {
    "use strict";
    var p = layui.$, c = layui.lay, m = layui.laytpl, O = layui.laypage, h = layui.layer, f = layui.form,
        v = layui.util, u = layui.hint(), g = layui.device(), b = {
            config: {
        ...
        }, w = "table", t = ".layui-table", T = "layui-hide", L = "layui-hide-v", N = "layui-none", _ = "layui-table-view",
        ...
        I = p(window), F = p(document), n = function (e) {
            ...
            i[0] && (t = t.split("-"), t = a.cols[t[1]][t[2]], e ? l-- : l++, i.attr("colspan", l), i[l ? "removeClass" : "addClass"](T), t.colspan2 = l, t.hide = l < 1, (a = i.data("parentkey")) && this.setParentCol(e, a))
            ...
            var t, a, n = this, d = n.config, i = 0, c = 0, r = 0, s = 0, y = n.setInit("width"),
                e = (n.eachCols(function (e, t) {
                    ...
                    layui.each(d.cols, function (e, n) {
                        layui.each(n, function (e, t) {
                            ...
                            t ? t.colGroup || t.hide || (o ? r && r < i ? (c--, a = i) : r && l < r && (c--, a = l) : (a = t.width || 0, /\d+%$/.test(a) ? l < (a = (a = Math.floor(parseFloat(a) / 100 * y)) < i ? i : a) && (a = l) : a ? "normal" === t.type && (a < i && (t.width = a = i), l < a && (t.width = a = l)) : (t.width = a = 0, c++)), t.hide && (a = 0), s += a) : n.splice(e, 1)
                        })
                    }), s < y && 0 < c && (r = (y - s) / c)
            ...
            return l = l || 1, layui.each(t, function (o, d) {
                ...
                "array" === layui.type(d) && 0 === d.length || (d[b.config.numbersName] = s, a || (d[b.config.indexName] = o), y.eachCols(function (e, l) {
                    ...
                    n !== undefined && null !== n || (n = ""), l.colGroup || (t = ['<td data-field="' + e + '" data-key="' + a + '" ' + (e = [], (t = "function" == typeof l.edit ? l.edit(d) : l.edit) && e.push('data-edit="' + t + '"'), l.templet && e.push('data-content="' + v.escape(n) + '"'), l.toolbar && e.push('data-off="true"'), l.event && e.push('lay-event="' + l.event + '"'), l.minWidth && e.push('data-minwidth="' + l.minWidth + '"'), l.maxWidth && e.push('data-maxwidth="' + l.maxWidth + '"'), e.join(" ")) + ' class="' + (t = [], l.hide && t.push(T), l.field || t.push(M), t.join(" ")) + '">', '<div class="layui-table-cell laytable-cell-' + ("normal" === l.type ? a : a + " laytable-cell-" + l.type) + '"' + (l.align ? ' align="' + l.align + '"' : "") + (e = [], l.style && e.push('style="' + l.style + '"'), e.join(" ")) + ">" + function () {
            ...
            var a = this, i = a.config, t = e.res, l = e.curr, n = e.count, o = e.sort, d = t[i.response.dataName] || [],
                t = t[i.response.totalRowName], c = [], r = [], s = [], y = function () {
            ...
            r.totalRow && (layui.each(e, function (e, i) {
                ...
                var a, e = t.field || e, i = o && o[t.field], l = "totalRowDecimals" in t ? t.totalRowDecimals : 2,
                    ...
                    l = (a = t.totalRowText || "", (n = {LAY_COL: t})[e] = l, n = t.totalRow && C.call(c, {
                        item3: t,
                        content: l,
                        tplData: n
            ...
            t.sortKey = {
                field: d,
                sort: l.type
            }, i.autoSort && ("asc" === l.type ? e = layui.sort(o, d, null, !0) : "desc" === l.type ? e = layui.sort(o, d, !0, !0) : (e = layui.sort(o, b.config.indexName, null, !0), delete t.sortKey, delete i.initSort)), a[i.response.dataName] = e || o, t.renderData({
                res: a,
                curr: t.page,
                count: t.count,
                sort: !0,
            ...
            })), l && (e = parseFloat(l) - (i.layHeader.outerHeight() || 38) - 1, t.toolbar && (e -= i.layTool.outerHeight() || 50), t.totalRow && (e -= i.layTotal.outerHeight() || 40), (t.page || t.pagebar) && (e -= i.layPage.outerHeight() || 43), t.maxHeight ? layui.each({
                elem: l,
                layMain: e
            }, function (e, t) {
            ...
            e.layFixed.find(R).css("height", t.height() >= n ? n : "auto"), e.layFixRight[b.cache[e.key] && b.cache[e.key].length && 0 < l ? "removeClass" : "addClass"](T), e.layFixRight.css("right", a - 1)
        }, n.prototype.events = function () {
            var s = this, y = s.config, c = y.elem.attr("lay-filter"), e = s.layHeader.find("th"), u = ".layui-table-cell",
                o = p("body"), d = {}, n = (s.layTool.on("click", "*[lay-event]", function (e) {
                    var a, i = p(this), t = i.attr("lay-event"), l = function (e) {
                        var t = p(e.list), a = p('<ul class="' + j + '"></ul>');
                        a.html(t), y.height && a.css("max-height", y.height - (s.layTool.outerHeight() || 50)), i.find("." + j)[0] || i.append(a), s.renderForm(), a.on("click", function (e) {
                            layui.stope(e)
                        }), e.done && e.done(a, t)
                    };
                                ...
                                list: (a = [], s.eachCols(function (e, t) {
                                    ...
                                    f.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                                        var e = p(e.elem), t = this.checked, a = e.data("key"), i = s.col(a), l = i.hide,
                                            e = e.data("parentkey");
                                        i.key && (i.hide = !t, s.elem.find('*[data-key="' + a + '"]')[t ? "removeClass" : "addClass"](T), l != i.hide && s.setParentCol(!t, e), s.resize(), layui.event.call(this, w, "colToggled(" + c + ")", {
                                            col: i,
                                            config: y
                                        }))
                                    })
                    ...
                    layui.event.call(this, w, "toolbar(" + c + ")", p.extend({event: t, config: y}, {}))
                }), s.layPagebar.on("click", "*[lay-event]", function (e) {
                    var t = p(this).attr("lay-event");
                    layui.event.call(this, w, "pagebar(" + c + ")", p.extend({event: t, config: y}, {}))
                    ...
                    var t, a;
                    x.eventMoveElem && (t = x.eventMoveElem.data(S) || {}, x.eventMoveElem.data("resizing", 1), e.preventDefault(), t.rule && (e = t.ruleWidth + e.clientX - t.offset[0], a = x.eventMoveElem.closest("." + _).attr("lay-id"), (a = k(a)) && ((e = e < t.minWidth ? t.minWidth : e) > t.maxWidth && (e = t.maxWidth), t.rule.style.width = e + "px", a.setGroupWidth(x.eventMoveElem), h.close(s.tipsIndex))))
                }).on("mouseup", function (e) {
                    var t, a, i, l, n;
                    x.eventMoveElem && (i = (t = x.eventMoveElem).closest("." + _).attr("lay-id"), (a = k(i)) && (i = t.data("key"), l = a.col(i), n = a.config.elem.attr("lay-filter"), d = {}, o.css("cursor", ""), a.scrollPatch(), t.removeData(S), delete x.eventMoveElem, a.getCssRule(i, function (e) {
                    ...
                    var t = p(this).parents("tr").eq(0).data("index"), c = s.layBody.find('tr[data-index="' + t + '"]'),
                        r = (r = b.cache[s.key] || [])[t] || {}, a = {
                            tr: c, config: y, data: b.clearCacheKey(r), index: t, del: function () {
                                b.cache[s.key][t] = [], c.remove(), s.scrollPatch()
                            }, update: function (e, d) {
                                e = e || {}, layui.each(e, function (i, l) {
                                    ...
                                    r[i] = a.data[i] = l, s.eachCols(function (e, t) {
                                        ...
                                        })), n.data("content", l)) : d && (t.templet || t.toolbar) && (e = c.children('td[data-field="' + (t.field || e) + '"]'), a = r[t.field], e.children(u).html(C.call(s, {
                                            item3: t,
                                            content: a,
                                            tplData: p.extend({LAY_COL: t}, r)
                                        })), e.data("content", a))
                    ...
                    var e = p(this).prev(), t = s.layBody.find('input[name="layTableCheckbox"]'),
                    ...
                    }), s.syncCheckAll(), s.renderForm("checkbox")) : (s.setCheckData(a, i), s.syncCheckAll()), layui.event.call(e[0], w, "checkbox(" + c + ")", n.call(e[0], {
                        checked: i,
                        type: l ? "all" : "one"
                    })))
                    ...
                    e[0].disabled || (s.setRowChecked({
                        type: "radio",
                        index: a
                    }), layui.event.call(e[0], w, "radio(" + c + ")", n.call(e[0], {checked: t})))
                    ...
                    var t = p(this);
                    t.data("off") || layui.event.call(this, w, e + "(" + c + ")", n.call(t.children("td")[0]))
                }), r = function (e, t) {
                    var a, i, l, n;
                    ...
                    var e = p(this), t = e.parent(), a = this.value, i = e.parent().data("field"),
                        e = e.closest("tr").data("index"), e = b.cache[s.key][e], l = n.call(t[0], {
                    ...
                    e[i] = a, l.update(e), layui.event.call(t[0], w, "edit(" + c + ")", l)
                }).on("blur", "." + E, function () {
                    p(this).remove()
                    ...
                    layui.event.call(this, w, (e || "tool") + "(" + c + ")", n.call(this, {event: t.attr("lay-event")})), s.setRowChecked({
                        type: "radio",
                        index: a
                    }, !0)
                });
            s.layBody.on("click", "*[lay-event]", function (e) {
                ...
                s.layHeader.scrollLeft(t), s.layTotal.scrollLeft(t), s.layFixed.find(R).scrollTop(e), h.close(s.tipsIndex)
    ...
    b.eachCols = function (e, a, i) {
        ...
        var o, d, i, c, l = (a = "object" == typeof a ? a : (l = {}, a && (l.type = a), l)).type || "csv",
            r = x.that[e], n = x.config[e] || {}, s = {csv: "text/csv", xls: "application/vnd.ms-excel"}[l],
            y = document.createElement("a");
        if (g.ie) return u.error("IE_NOT_SUPPORT_EXPORTS");
        y.href = "data:" + s + ";charset=utf-8,\ufeff" + encodeURIComponent((o = [], d = [], i = [], c = {}, layui.each(t, function (i, l) {
            var n = [];
            "object" == typeof e ? (layui.each(e, function (e, t) {
                ...
                var a;
                t.field && "normal" == t.type && (t.hide ? 0 == i && (c[t.field] = !0) : ((a = l[t.field]) !== undefined && null !== a || (a = ""), 0 == i && o.push(t.fieldTitle || t.title || t.field || ""), a = (a = C.call(r, {
                    item3: t,
                    content: a,
                    tplData: l,
                    text: "text",
...
layui.define(["table"], function (e) {
    "use strict";
    var S = layui.$, p = layui.form, E = layui.table, u = layui.hint(), a = {}, h = {
            config: {}, on: E.on, eachCols: E.eachCols, index: E.index, set: function (e) {
                var t = this;
                return t.config = S.extend({}, t.config, e), t
            }, resize: E.resize, getOptions: E.getOptions, hideCol: E.hideCol
        }, i = function () {
        ...
        }, P = "layui-hide", L = ".layui-table-main", B = ".layui-table-fixed-l", F = ".layui-table-fixed-r",
        x = "layui-table-tree", Y = "LAY_DATA_INDEX", m = "LAY_DATA_INDEX_HISTORY", f = "LAY_PARENT_INDEX",
        s = "LAY_CHECKBOX_HALF", q = "LAY_EXPAND", X = "LAY_HAS_EXPANDED", H = "LAY_ASYNC_STATUS", t = function (e) {
            var t = this;
            t.index = ++h.index, t.config = S.extend(!0, {}, t.config, h.config, e), t.init(), t.render()
        }, c = function (n, i, e) {
            var l = E.cache[n];
            layui.each(e || l, function (e, t) {
                var a = t[Y];
            ...
            var l = j(i), t = S.extend(!0, {}, l.getOptions(), a), n = t.tree, d = n.customName.children,
                r = (delete a.hasNumberCol, delete a.hasChecboxCol, delete a.hasRadioCol, E.eachCols(null, function (e, t) {
            ...
            t.url ? e && (!r || r.mod) || (a.parseData = function () {
                var e = arguments, t = e[0],
                    e = ("function" === layui.type(r) && (t = r.apply(this, e) || e[0]), this.response.dataName);
                return n.data.isSimpleData && !n["async"].enable && (t[e] = l.flatToTree(t[e])), l.initData(t[e]), t
            }, a.parseData.mod = !0) : (a.data = a.data || [], n.data.isSimpleData && (a.data = l.flatToTree(a.data)), a.initSort && a.initSort.type && (a.data = layui.sort(a.data, a.initSort.field, "desc" === a.initSort.type)), l.initData(a.data)), e && (!o || o.mod) || (a.done = function () {
                ...
                if (n.length && (e = h.checkStatus(i), n.prop({
    ...
    t.prototype.init = function () {
        var e = this.config, t = E.render(S.extend({}, e, {data: [], url: "", done: null})), a = t.config.id;
        ...
        return this.tableIns ? E.getOptions(this.tableIns.config.id) : this.config
    }, t.prototype.flatToTree = function (e) {
        var a, n, i, t, l, d = this.getOptions(), r = d.tree, o = r.customName, d = d.id;
        return e = e || E.cache[d], d = e, a = o.id, n = o.pid, i = o.children, t = r.data.rootPid, a = a || "id", n = n || "parentId", i = i || "children", l = {}, layui.each(d, function (e, t) {
            l[t[a]] = S.extend({}, t), l[t[a]][i] = []
        ...
        return layui.each(e, function (e, t) {
            var e = (i ? i + "-" : "") + e, a = S.extend({}, t);
            a[r] = null, a[o] = t[o] || n, c.push(a), c = c.concat(l.treeToFlat(t[r], t[d.id], e))
        }), c
    }, t.prototype.getNodeDataByIndex = function (a, e, t) {
        var n = this.getOptions(), i = n.tree, l = n.id, d = E.cache[l][a];
        if ("delete" !== t && d) return S.extend(d, t), e ? S.extend({}, d) : d;
        for (var d = this.getTableData(), r = (a += "").split("-"), o = d, c = n.url || 1 < r.length ? null : E.cache[l], u = 0, f = i.customName.children; u < r.length; u++) {
            if (t && u === r.length - 1) {
                if ("delete" === t) return c && layui.each(c, function (e, t) {
                    if (t[Y] === a) return c.splice(e, 1), !0
                }), (u ? o[f] : o).splice(r[u], 1)[0];
                S.extend((u ? o[f] : o)[r[u]], t)
            }
            o = (u ? o[f] : o)[r[u]]
        }
        return e ? S.extend({}, o) : o
    }, h.getNodeDataByIndex = function (e, t) {
        e = j(e);
    ...
    t.prototype.initData = function (e, a) {
        ...
        return layui.each(e, function (e, t) {
            l in t || (t[l] = !(!t[d] || !t[d].length)), t[m] = t[Y], t[f] = a = a || "";
            e = t[Y] = (a ? a + "-" : "") + e;
            n.initData(t[d] || [], e)
        }), a || c(t, d), e
    };
    var R = function (t, a, n, i, l) {
        var e = t.trElem, d = e.closest(".layui-table-view"), r = (d.attr("lay-filter"), d.attr("lay-id")),
            o = E.getOptions(r), c = o.tree || {}, u = c.customName || {}, f = u.isParent, s = e.attr("lay-data-index"),
            y = j(r), p = (y.getTableData(), y.getNodeDataByIndex(s)), h = (e.data("level") || 0) + 1,
            x = "boolean" !== layui.type(a), e = x ? !p[q] : a, m = p[f] ? e : null;
        if (l && e != p[q] && (!p[H] || "local" === p[H])) {
            var v = c.callback.beforeExpand;
            if ("function" === layui.type(v) && !1 === v(r, p, a)) return m
        }
        var v = p[X], b = d.find('tr[lay-data-index="' + s + '"]'), g = b.find(".layui-table-tree-flexIcon"),
            b = (g.html(e ? c.view.flexIconOpen : c.view.flexIconClose), p[f] && g.css("visibility", "visible"), c.view.showIcon && p[f] && !p.icon && !c.view.icon && b.find(".layui-table-tree-nodeIcon").html(e ? c.view.iconOpen : c.view.iconClose), p[u.children] || []);
        if (e) if (v) p[q] = e, d.find(b.map(function (e, t, a) {
            return 'tr[lay-data-index="' + e[Y] + '"]'
        }).join(",")).removeClass(P), layui.each(b, function (e, t) {
            n && !x ? R({trElem: d.find('tr[lay-data-index="' + t[Y] + '"]').first()}, a, n, i, l) : t[q] && R({trElem: d.find('tr[lay-data-index="' + t[Y] + '"]').first()}, !0)
        }); else {
            var N, D, _, C, T, I, k, A, w = c["async"] || {}, O = w.url || o.url;
            if (w.enable && p[f] && O && !p[H]) return p[H] = "loading", N = S.extend({}, w.where || o.where), f = w.autoParam, layui.each(f, function (e, t) {
                t = t.split("=");
                N[t[0].trim()] = p[(t[1] || t[0]).trim()]
            }), (f = w.contentType || o.contentType) && 0 == f.indexOf("application/json") && (N = JSON.stringify(N)), k = w.method || o.method, D = w.dataType || o.dataType, _ = w.jsonpCallback || o.jsonpCallback, C = w.headers || o.headers, T = w.parseData || o.parseData, I = w.response || o.response, g.html('<i class="layui-icon layui-icon-loading layui-anim layui-anim-loop layui-anim-rotate"></i>'), S.ajax({
                type: k || "get",
                url: O,
                contentType: f,
                data: N,
                ...
                headers: C || {},
                success: function (e) {
                    p[H] = "success", (e = "function" == typeof T ? T.call(o, e) || e : e)[I.statusName] != I.statusCode ? (p[H] = "error", g.html('<i class="layui-icon layui-icon-refresh"></i>')) : (p[u.children] = e[I.dataName], y.initData(p[u.children], p[Y]), R(t, !0, !x && n, i, l))
                },
                error: function (e, t) {
                    p[H] = "error", "function" == typeof o.error && o.error(e, t)
                }
            }), m;
            p[q] = e, v = p[X] = !0, b.length && (o.initSort && !o.url && (b = (w = o.initSort).type ? p[u.children] = layui.sort(b, w.field, "desc" === w.type) : p[u.children] = layui.sort(b, E.config.indexName)), y.initData(p[u.children], p[Y]), k = E.getTrHtml(r, b, null, null, s), A = {
                trs: S(k.trs.join("")),
                trs_fixed: S(k.trs_fixed.join("")),
                trs_fixed_r: S(k.trs_fixed_r.join(""))
            }, layui.each(b, function (e, t) {
                A.trs.eq(e).attr({
                    "data-index": t[Y],
                    "lay-data-index": t[Y],
                    "data-level": h
                }), A.trs_fixed.eq(e).attr({
                    "data-index": t[Y],
                    "lay-data-index": t[Y],
                    "data-level": h
                }), A.trs_fixed_r.eq(e).attr({"data-index": t[Y], "lay-data-index": t[Y], "data-level": h})
            }), d.find(L).find('tbody tr[lay-data-index="' + s + '"]').after(A.trs), d.find(B).find('tbody tr[lay-data-index="' + s + '"]').after(A.trs_fixed), d.find(F).find('tbody tr[lay-data-index="' + s + '"]').after(A.trs_fixed_r), layui.each(A, function (e, t) {
                y.renderTreeTable(t, h)
            }), n && !x && layui.each(b, function (e, t) {
                R({trElem: d.find('tr[lay-data-index="' + t[Y] + '"]').first()}, a, n, i, l)
            }))
        } else p[q] = e, n && !x ? (layui.each(b, function (e, t) {
            R({trElem: d.find('tr[lay-data-index="' + t[Y] + '"]').first()}, a, n, i, l)
        }), d.find(b.map(function (e, t, a) {
            return 'tr[lay-data-index="' + e[Y] + '"]'
        }).join(",")).addClass(P)) : (O = y.treeToFlat(b, p[u.id], s), d.find(O.map(function (e, t, a) {
            return 'tr[lay-data-index="' + e[Y] + '"]'
        }).join(",")).addClass(P));
        return E.resize(r), l && "loading" !== p[H] && (f = c.callback.onExpand, "function" === layui.type(f) && f(r, p, a)), m
    }, d = (h.expandNode = function (e, t) {
        var a, n, i, e = j(e);
        if (e) return a = (t = t || {}).index, n = t.expandFlag, i = t.inherit, t = t.callbackFlag, e = e.getOptions().elem.next(), R({trElem: e.find('tr[lay-data-index="' + a + '"]').first()}, n, i, null, t)
    }, h.expandAll = function (a, e) {
        if ("boolean" !== layui.type(e)) return u.error("expandAll \u7684\u5c55\u5f00\u72b6\u6001\u53c2\u6570\u53ea\u63a5\u6536true/false");
        var t = j(a);
        if (t) {
            var n = t.getOptions(), i = n.tree, l = n.elem.next();
            if (e) {
                n = h.getData(a, !0);
                if (i["async"].enable) {
                    var d = !0, r = i.customName.isParent;
                    if (layui.each(n, function (e, t) {
                        if (t[r] && !t[H]) return !(d = !1)
                    }), !d) return void layui.each(h.getData(a), function (e, t) {
                        h.expandNode(a, {index: t[Y], expandFlag: !0, inherit: !0})
                    })
                }
                var o, c = !0;
                layui.each(n, function (e, t) {
                    if (!t[X]) return !(c = !1)
                }), c ? (t.updateStatus(null, {LAY_EXPAND: !0}), l.find('tbody tr[data-level!="0"]').removeClass(P), l.find(".layui-table-tree-flexIcon").html(i.view.flexIconOpen), l.find(".layui-table-tree-nodeIcon").html(i.view.iconOpen)) : (t.updateStatus(null, {
                    LAY_EXPAND: !0,
                    LAY_HAS_EXPANDED: !0
                }), e = E.getTrHtml(a, n), o = {
                    trs: S(e.trs.join("")),
                    trs_fixed: S(e.trs_fixed.join("")),
                    trs_fixed_r: S(e.trs_fixed_r.join(""))
                }, layui.each(n, function (e, t) {
                    ...
                    o.trs.eq(e).attr({
                        ...
                        "lay-data-index": t[Y],
                        "data-level": a
                    }), o.trs_fixed_r.eq(e).attr({"data-index": t[Y], "lay-data-index": t[Y], "data-level": a})
                ...
                t.updateStatus(null, {LAY_EXPAND: !1}), l.find('.layui-table-box tbody tr[data-level!="0"]').addClass(P);
                e = l.find('tbody tr[data-level="0"]');
                e.find(".layui-table-tree-flexIcon").html(i.view.flexIconClose), i.view.showIcon && e.find(".layui-table-tree-nodeIcon").html(i.view.iconClose)
            }
            h.resize(a)
        }
    }, t.prototype.renderTreeTable = function (e, t, a) {
        var n = this.getOptions(), i = n.elem.next(), l = (i.addClass(x), n.id), d = n.tree || {},
            r = (d.data, d.view || {}), o = d.customName || {}, c = o.isParent, u = i.attr("lay-filter"), f = this,
            s = ((t = t || 0) || (i.find(".layui-table-body tr:not([data-level])").attr("data-level", t), layui.each(E.cache[l], function (e, t) {
                i.find('.layui-table-main tbody tr[data-level="0"]:eq(' + e + ")").attr("lay-data-index", t[Y]), i.find('.layui-table-fixed-l tbody tr[data-level="0"]:eq(' + e + ")").attr("lay-data-index", t[Y]), i.find('.layui-table-fixed-r tbody tr[data-level="0"]:eq(' + e + ")").attr("lay-data-index", t[Y])
            })), {}), t = o.name, y = d.view.indent || 14;
        layui.each(e.find('td[data-field="' + t + '"]'), function (e, t) {
            var a, n = (t = S(t)).closest("tr"), i = t.children(".layui-table-cell");
            i.hasClass("layui-table-tree-item") || (i.addClass("layui-table-tree-item"), (i = n.attr("lay-data-index")) && ((a = f.getNodeDataByIndex(i))[q] && (s[i] = !0), i = t.find("div.layui-table-cell").html(), t.find("div.layui-table-cell").html(['<div class="layui-inline layui-table-tree-flexIcon" ', 'style="', "margin-left: " + y * n.attr("data-level") + "px;", a[c] || r.showFlexIconIfNotParent ? "" : " visibility: hidden;", '">', a[q] ? d.view.flexIconOpen : d.view.flexIconClose, "</div>", '<div class="layui-inline layui-table-tree-nodeIcon">', d.view.showIcon && (a.icon || d.view.icon || (a[c] ? d.view.iconClose : d.view.iconLeaf)) || "", "</div>", i].join("")).find(".layui-table-tree-flexIcon").on("click", function (e) {
                layui.stope(e), R({trElem: n}, null, null, null, !0)
            })))
        }), !1 !== a && layui.each(s, function (e, t) {
            e = i.find('tr[lay-data-index="' + e + '"]');
            e.find(".layui-table-tree-flexIcon").html(d.view.flexIconOpen), R({trElem: e.first()}, !0)
        }), n.hasNumberCol && this.formatNumber(l), p.render(null, u)
    }, t.prototype.formatNumber = function (e) {
        var t = this;
        clearTimeout(e), a[e] = setTimeout(function () {
            var n, e, i, l;
            e = (n = t).getOptions(), i = e.elem.next(), l = 0, layui.each(n.treeToFlat(E.cache[e.id]), function (e, t) {
                var a;
                layui.isArray(t) || ((a = n.getNodeDataByIndex(t[Y])).LAY_NUM = ++l, i.find('tr[lay-data-index="' + t[Y] + '"] .laytable-cell-numbers').html(a.LAY_NUM))
            })
        }, 10)
    }, t.prototype.render = function (e) {
        var t = this;
        t.tableIns = E["reloadData" === e ? "reloadData" : "reload"](t.tableIns.config.id, S.extend(!0, {}, t.config)), t.config = t.tableIns.config
    }, t.prototype.reload = function (e, t, a) {
        var n = this;
        e = e || {}, delete n.haveInit, layui.each(e, function (e, t) {
            "array" === layui.type(t) && delete n.config[e]
        }), l(n.config.id, e, !0), n.config = S.extend(t, {}, n.config, e), n.render(a)
    }, h.reloadData = function () {
        var e = S.extend(!0, [], arguments);
        return e[3] = "reloadData", h.reload.apply(null, e)
    }, function (e, a, n) {
        var i = [];
        return layui.each(e, function (e, t) {
            "function" === layui.type(a) ? a(t) : S.extend(t, a), i.push(S.extend({}, t)), i = i.concat(d(t[n], a, n))
        }), i
    }), n = (t.prototype.updateStatus = function (e, t) {
        var a = this.getOptions(), n = a.tree;
        return e = e || E.cache[a.id], d(e, t, n.customName.children)
    }, t.prototype.getTableData = function () {
        var e = this.getOptions();
        return e.url ? E.cache[e.id] : e.data
    }, h.updateStatus = function (e, t, a) {
        var e = j(e), n = e.getOptions();
        return a = a || (n.url ? E.cache[n.id] : n.data), e.updateStatus(a, t)
    }, h.sort = function (e) {
        var t, a, n, i, l = j(e);
        l && (a = (t = l.getOptions()).initSort, t.url ? t.autoSort && (n = l.initData(), (i = {})[t.response.dataName] = n, "function" == typeof t.done && t.done(i, l.page, l.count)) : (a.type ? t.data = layui.sort(t.data, a.field, "desc" === a.type) : t.data = layui.sort(t.data, E.config.indexName), l.initData(t.data), h.reloadData(e)))
    }, function (t) {
        var a = t.config.id, n = j(a), i = t.data = h.getNodeDataByIndex(a, t.index), l = i[Y],
            d = (t.dataIndex = l, t.update);
        t.update = function () {
            var e = arguments, e = (S.extend(n.getNodeDataByIndex(l), e[0]), d.apply(this, e));
            return t.tr.find('td[data-field="' + t.config.tree.customName.name + '"]').children("div.layui-table-cell").removeClass("layui-table-tree-item"), n.renderTreeTable(t.tr, t.tr.attr("data-level"), !1), e
        }, t.del = function () {
            h.removeNode(a, i)
        }, t.setRowChecked = function (e) {
            h.setRowChecked(a, {index: i, checked: e})
        }
    }), o = (h.updateNode = function (e, a, t) {
        var n, i, l, d, r, o = j(e);
        o && ((d = o.getOptions()).tree, d = (n = d.elem.next()).find('tr[lay-data-index="' + a + '"]'), i = d.attr("data-index"), l = d.attr("data-level"), t && (d = o.getNodeDataByIndex(a, !1, t), r = E.getTrHtml(e, [d]), layui.each(["main", "fixed-l", "fixed-r"], function (e, t) {
            n.find(".layui-table-" + t + ' tbody tr[lay-data-index="' + a + '"]').replaceWith(S(r[["trs", "trs_fixed", "trs_fixed_r"][e]].join("")).attr({
                "data-index": i,
                "lay-data-index": a,
                "data-level": l
            }))
        }), o.renderTreeTable(n.find('tr[lay-data-index="' + a + '"]'), l)))
    }, h.removeNode = function (e, t) {
        var a, n, i, l, d, r = j(e);
        r && (d = (a = r.getOptions()).tree, n = a.elem.next(), i = [], t = r.getNodeDataByIndex("string" === layui.type(t) ? t : t[Y], !1, "delete"), l = r.getNodeDataByIndex(t[f]), r.updateCheckStatus(l, !0), l = r.treeToFlat([t], t[d.customName.pid], t[f]), layui.each(l, function (e, t) {
        ...
        if (y) return u = y.getOptions(), f = u.tree, a = u.elem.next(), s = (t = t || {}).parentIndex, i = t.index, l = t.data, t = t.focus, n = (s = "number" === layui.type(s) ? s.toString() : s) ? y.getNodeDataByIndex(s) : null, i = "number" === layui.type(i) ? i : -1, l = S.extend(!0, [], layui.isArray(l) ? l : [l]), y.getTableData(), n ? (d = f.customName.isParent, f = f.customName.children, n[d] = !0, c = (c = n[f]) ? (r = c.splice(-1 === i ? c.length : i), n[f] = c.concat(l, r)) : n[f] = l, y.updateStatus(c, function (e) {
            ...
            return 'tr[lay-data-index="' + e[Y] + '"]'
        }).join(",")).remove(), y.initData(), n[X] = !1, n[H] = "local", R({trElem: a.find('tr[lay-data-index="' + s + '"]')}, !0)) : (r = E.cache[e].splice(-1 === i ? E.cache[e].length : i), E.cache[e] = E.cache[e].concat(l, r), u.url || (u.page ? (c = u.page, u.data.splice.apply(u.data, [c.limit * (c.curr - 1), c.limit].concat(E.cache[e]))) : u.data = E.cache[e]), y.initData(), f = E.getTrHtml(e, l), o = {
            trs: S(f.trs.join("")),
            trs_fixed: S(f.trs_fixed.join("")),
            trs_fixed_r: S(f.trs_fixed_r.join(""))
        }, layui.each(l, function (e, t) {
            o.trs.eq(e).attr({
                "data-index": t[Y],
                "lay-data-index": t[Y],
                ...
                "lay-data-index": t[Y],
                "data-level": "0"
            }), o.trs_fixed_r.eq(e).attr({"data-index": t[Y], "lay-data-index": t[Y], "data-level": "0"})
        }), s = parseInt(l[0][Y]) - 1, c = a.find(L), u = a.find(B), f = a.find(F), -1 == s ? (c.find('tr[data-level="0"][data-index="0"]').before(o.trs), u.find('tr[data-level="0"][data-index="0"]').before(o.trs_fixed), f.find('tr[data-level="0"][data-index="0"]').before(o.trs_fixed_r)) : -1 === i ? (c.find("tbody").append(o.trs), u.find("tbody").append(o.trs_fixed), f.find("tbody").append(o.trs_fixed_r)) : (s = r[0][m], c.find('tr[data-level="0"][data-index="' + s + '"]').before(o.trs), u.find('tr[data-level="0"][data-index="' + s + '"]').before(o.trs_fixed), f.find('tr[data-level="0"][data-index="' + s + '"]').before(o.trs_fixed_r)), layui.each(E.cache[e], function (e, t) {
            a.find('tr[data-level="0"][lay-data-index="' + t[Y] + '"]').attr("data-index", e)
        }), y.renderTreeTable(a.find(l.map(function (e, t, a) {
            return 'tr[lay-data-index="' + e[Y] + '"]'
        }).join(",")))), y.updateCheckStatus(n, !0), h.resize(e), t && a.find(L).find('tr[lay-data-index="' + l[0][Y] + '"]').get(0).scrollIntoViewIfNeeded(), l
    }, h.checkStatus = function (e) {
        var t, a;
        if (j(e)) return t = h.getData(e, !0).filter(function (e, t, a) {
            return e[E.config.checkName]
        }), a = !0, layui.each(E.cache[e], function (e, t) {
            if (!t[E.config.checkName]) return !(a = !1)
        }), {data: t, isAll: a}
    }, h.on("sort", function (e) {
        var e = e.config, t = e.elem.next(), e = e.id;
        t.hasClass(x) && h.sort(e)
    }), h.on("row", function (e) {
        e.config.elem.next().hasClass(x) && n(e)
    }), h.on("rowDouble", function (e) {
        var t = e.config, a = t.elem.next();
        t.id;
        a.hasClass(x) && (n(e), (t.tree || {}).view.dblClickExpand && R({trElem: e.tr.first()}, null, null, null, !0))
    }), h.on("rowContextmenu", function (e) {
        var t = e.config, a = t.elem.next();
        t.id;
        a.hasClass(x) && n(e)
    }), h.on("tool", function (e) {
        var t = e.config, a = t.elem.next();
        t.id;
        a.hasClass(x) && n(e)
    }), h.on("edit", function (e) {
        var t = e.config, a = t.elem.next();
        t.id;
        a.hasClass(x) && (n(e), e.field === t.tree.customName.name && e.update({}))
    }), h.on("radio", function (e) {
        var t = e.config, a = t.elem.next(), t = t.id;
        a.hasClass(x) && (a = j(t), n(e), o.call(a, e.tr, e.checked))
    }), t.prototype.updateCheckStatus = function (e, t) {
        var a = this.getOptions(), n = (a.tree, a.id), i = a.elem.next(), l = E.config.checkName,
            d = (e && (a = this.updateParentCheckStatus(e, t), layui.each(a, function (e, t) {
                p.render(i.find('tr[lay-data-index="' + t[Y] + '"]  input[name="layTableCheckbox"]:not(:disabled)').prop({
                    checked: t[l],
                    indeterminate: t[s]
                }))
            })), !0), r = !1;
        return layui.each(E.cache[n], function (e, t) {
            (t[l] || t[s]) && (r = !0), t[l] || (d = !1)
        }), r = r && !d, p.render(i.find('input[name="layTableCheckbox"][lay-filter="layTableAllChoose"]').prop({
            checked: d,
            indeterminate: r
        })), d
    }, t.prototype.updateParentCheckStatus = function (a, n) {
        var e = this.getOptions(), t = e.tree, e = e.id, i = E.config.checkName, t = t.customName.children, l = [];
        ...
        }), a[i] = n, l.push(S.extend({}, a)), l = a[f] ? l.concat(this.updateParentCheckStatus(E.cache[e][a[f]], n)) : l
    }, function (e, t, a) {
        ...
        if (a) {
            ...
            var c, a = n.getNodeDataByIndex(e.attr("data-index")), u = E.config.checkName;
            if (!o) return i.tree.customName.isParent, t = "boolean" === layui.type(t) ? t : !a[u], o = n.updateStatus(a ? [a] : E.cache[l], function (e) {
                e[E.config.disabledName] || (e[u] = t, e[s] = !1)
            }), p.render(d.find(o.map(function (e) {
            ...
            a && (n.updateStatus(null, function (e) {
                e[u] && (e[u] = !1, p.render(d.find('tr[lay-data-index="' + e[Y] + '"] input[type="radio"][lay-type="layTableRadio"]').prop("checked", !1)))
            }), a[u] = t, p.render(e.find('input[type="radio"][lay-type="layTableRadio"]').prop("checked", t)))
        }
    });
    h.on("checkbox", function (e) {
        var t = e.config, a = t.elem.next(), t = t.id;
        a.hasClass(x) && (a = j(t), t = e.checked, n(e), e.isAll = o.call(a, e.tr, t))
    }), h.setRowChecked = function (e, t) {
        var a, n, i, l, d, r = j(e);
        r && (a = r.getOptions().elem.next(), i = (t = t || {}).index, n = t.checked, t = t.callbackFlag, i = "string" === layui.type(i) ? i : i[Y], (l = r.getNodeDataByIndex(i)) && ((d = a.find('tr[lay-data-index="' + i + '"]')).length || (h.expandNode(e, {
            index: l[f],
            expandFlag: !0
        }), d = a.find('tr[lay-data-index="' + i + '"]')), o.call(r, d, n, t)))
    }, h.checkAllNodes = function (e, t) {
        var a, e = j(e);
        e && (a = e.getOptions().elem.next(), o.call(e, a.find('tr[data-index="NONE"]'), !!t))
    }, h.getData = function (e, t) {
        var a = [];
        return layui.each(S.extend(!0, [], E.cache[e] || []), function (e, t) {
            a.push(t)
        }), t ? j(e).treeToFlat(a) : a
    }, i.that = {}, h.reload = function (e, t, a, n) {
        if (a = !1 !== a, j(e).config) return e = j(e), e.reload(t, a, n), i.call(e)
    }, h.render = function (e) {
        e = new t(e);
        return i.call(e)
    }, e("treeTable", h)
